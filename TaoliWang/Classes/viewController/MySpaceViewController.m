...
-(void)SinaShareBtnClick:(UIButton *)sender{
    [ShareCommon SinaShareWithContent:[NSString stringWithFormat:@"今天发现一好东西，分享给大家"]];
}
-(void)WeiXinShareBtnClick:(UIButton *)sender{
    [ShareCommon WeixinShareWithContent:[NSString stringWithFormat:@"今天发现一好东西，分享给大家"]];
}
-(void)QQSpaceShareBtnCLick:(UIButton *)sender{
    [ShareCommon QQSpaceShareWithContent:[NSString stringWithFormat:@"今天发现一好东西，分享给大家"]];
}
